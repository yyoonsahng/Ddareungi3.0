...
public class NetworkUtils {
    ...
    /**
     * return url that formed with base url and query
     */
    public static String buildUrl(String baseUrl, HashMap<String, String> querys) {

        HttpUrl.Builder urlBuilder = HttpUrl.get(baseUrl).newBuilder();
        for(HashMap.Entry<String, String> query : querys.entrySet()) {
