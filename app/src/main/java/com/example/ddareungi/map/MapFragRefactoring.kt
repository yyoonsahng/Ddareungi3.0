...
class MapFragRefactoring() : Fragment(), MapContract.View, OnMapReadyCallback, FabSpeedDial.MenuListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        with(root)
        {
            ...
            placeTypeBtn = (findViewById<FabSpeedDial>(R.id.map_place_fab)).also { it.setMenuListener(this@MapFragRefactoring) }
        }
